                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">انشئ بواسطة</th>
                            ...
                            @foreach($sections as $index => $section)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a
                                            class="modal-effect btn btn-danger btn-sm"
                                            data-effect="effect-scale"
                                            data-toggle="modal"
                                            href="#deleteSection"
                                            data-id="{{$section->id}}"
        ...
        <form action="{{url('sections/destroy')}}" method="post">
            ...
            <div class="modal" id="deleteSection">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">مسح القسم</h6>
                            <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span
                                    aria-hidden="true">&times;</span></button>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="id" id="id">
                            <p class="mb-2">هل أنت متاكد انك تريد حذف هذا القسم؟</p>
                            <div class="form-group">
