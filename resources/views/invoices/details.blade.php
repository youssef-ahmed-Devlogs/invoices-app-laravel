                                        ...
                                        <div class="tab-pane" id="tab6">
                                            ...
                                            <div class="card card-statistics">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form method="post"
                                                        action="{{ route('invoices.attachments.upload') }}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        ...
                                                                        <a class="btn btn-outline-success btn-sm"
                                                                            href="{{ route('invoices.view_file', [$invoice->invoice_number, $attachment->file_name]) }}"
                                                                            role="button"><i
                                                                                class="fas fa-eye"></i>&nbsp;
                                                                            عرض</a>

                                                                        <a class="btn btn-outline-info btn-sm"
                                                                            href="{{ route('invoices.download_file', [$invoice->invoice_number, $attachment->file_name]) }}"
                                                                            role="button"><i
    ...
    <div class="modal fade" id="delete_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('invoices.delete_file') }}" method="post">
