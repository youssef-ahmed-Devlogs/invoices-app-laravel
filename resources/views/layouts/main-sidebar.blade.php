        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('invoices.unPaid') }}">الفواتير الغير
                            مدفوعة</a></li>
                    <li><a class="slide-item" href="{{ route('invoices.paidPartial') }}">الفواتير المدفوعة
                            جزئيا</a></li>
                    <li><a class="slide-item" href="{{ route('invoices.archive') }}">الفواتير المؤرشفة
                        </a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}">تقارير
                            العملاء</a>
                    </li>
